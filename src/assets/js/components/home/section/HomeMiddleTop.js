...
const HomeMiddleTop = () => {
  return (
    <div className="home-middle-top-section tw-py-[50px] tw-px-[24px]">
      <div className="wrapper">
        <div className="tw-text-center tw-w-[477px] tw-max-w-full tw-m-auto tw-mb-[24px] md:tw-mb-[50px]">
        ...
        {/* Middle Boxes */}
        <div className="tw-flex tw-flex-wrap tw-justify-between tw-gap-[32px] md:tw-gap-0">
        ...
        {/* Middle Bottom */}
        <div className="tw-mt-[40px] tw-text-center tw-flex tw-flex-wrap tw-items-center tw-flex-col">

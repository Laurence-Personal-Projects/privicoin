...
const Header = () => {
    return (
        <header className="main-header tw-p-[24px] md:tw-py-[40px]">
            <div className="tw-flex tw-items-center tw-justify-between tw-flex-wrap">
                ...
                <Button title="Start Now" className="cta-btn tw-max-w-full tw-w-[160px] tw-pr-[40px] md:tw-w-[230px] md:tw-pr-[34px]" hasIcon={true} />
            </div>
        </header>
    );
};
